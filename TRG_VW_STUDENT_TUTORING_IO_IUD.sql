create or replace TRIGGER  "TRG_VW_STUDENT_TUTO_IO_IUD" 
INSTEAD OF INSERT or UPDATE or DELETE ON VW_STUDENT_TUTORING 
DECLARE 
  -- 
  l_add_id number;
...
begin 
	...
	l_vw_student_record.ACCOUNT_ID := :new.ACCOUNT_ID;
	l_vw_student_record.PREFERRED_HOURLY_RATE := :new.PREFERRED_HOURLY_RATE;
	l_vw_student_record.ACCOUNT_COMMENTS := :new.ACCOUNT_COMMENTS;
...
end TRG_VW_STUDENT_TUTO_IO_IUD;
/
