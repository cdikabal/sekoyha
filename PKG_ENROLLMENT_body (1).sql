...
-- ========================================
   ...
   begin 
    ...
    if pi_vw_student_record.PAR_SAME_ADDRESS_1 = 'Y' then
      l_par_1_id := l_student_add_id;
    else
      l_par_1_id := pkg_address.create_or_replace(
    ...
    if pi_vw_student_record.PAR_SAME_ADDRESS_2 = 'Y' then
      l_par_2_id := l_student_add_id;
    else
      l_par_2_id := pkg_address.create_or_replace(
    ...
    l_student_id :=
      pkg_student.create_replace( 
               ...
               p_country_id     => pi_vw_student_record.citizenship_country_id);
    -- -------
    -- Create parents
    -- -------
   exception 
